...
public class JavaScriptAlertPage extends BasePageObject {
    ...
    public JavaScriptAlertPage(WebDriver driver) throws AWTException {
    	openBrowser();
...
//    	 WebDriverWait wait = new WebDriverWait(driver, MAX_WAIT_TIME);
         Alert alert = (Alert) ExpectedConditions.alertIsPresent();
    ...
    public JavaScriptAlertPage accept_js_confirm() throws InterruptedException {
        Thread.sleep(100);
    ...
    public JavaScriptAlertPage dismiss_js_confirm() throws InterruptedException {
        Thread.sleep(100);
        Alert alert = driver.switchTo().alert();
...
//        WebDriverWait wait = new WebDriverWait(driver, MAX_WAIT_TIME);
        ...
        actual_js_prompt_content = ((Alert) alert).getText();
        input_js_prompt_text = with_text;
        ((Alert) alert).sendKeys(with_text);
        ((Alert) alert).accept();
        return this;
    }
